...
fig1_training_time.png shows total 10-epoch training time per framework and GPU count.
fig2_energy.png shows estimated energy consumption (avg power draw x training time).
fig3_accuracy.png shows final test accuracy after 10 epochs.
fig4_learning_curves.png shows test accuracy over training for all configurations.
